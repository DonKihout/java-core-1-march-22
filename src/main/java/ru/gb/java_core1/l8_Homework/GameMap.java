package ru.gb.java_core1.l8_Homework;
...
public class GameMap extends JPanel {
    ...
    private static final int DOT_SECOND_HUMAN = 3;
    ...
    private void update(MouseEvent e) {
        ...
        if(this.gameMode == MODE_VS_AI){
            ...
            if (count % 2 == 0){
                ...
                if (gameCheck(DOT_SECOND_HUMAN, STATE_WIN_HUMAN2)) {
                    return;
                }
            }
            count++;
        ...
        for (int y = 0; y < fieldSizeY; y++) {
            for (int x = 0; x < fieldSizeX; x++) {
                ...
                if (field[y][x] == DOT_HUMAN) {
                    g.drawImage(ImageIO.read(new File("res/cancel.png")),
                            x * cellWidth + DOT_PADDING,
                            y * cellHeight + DOT_PADDING,
                            cellWidth - DOT_PADDING * 2,
                            cellHeight - DOT_PADDING * 2,
                            null);
                } else if(field[y][x] == DOT_SECOND_HUMAN){
                    g.drawImage(ImageIO.read(new File("res/oval.png")),
                            x * cellWidth + DOT_PADDING,
                            y * cellHeight + DOT_PADDING,
                            cellWidth - DOT_PADDING * 2,
                            cellHeight - DOT_PADDING * 2,
